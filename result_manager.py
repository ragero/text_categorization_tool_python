# -*- coding: utf-8 -*-
"""result_manager.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fFljB1pH_pio_GdGWWIL5Jxf0jUjsEbX
"""
...
def get_dataframe(path_results):
  ...
  if (path.exists(path_results)):
    ...
    results = pd.DataFrame(columns=['Algorithm','Parameters','Fold_Number','Accuracy','Macro_F1','Micro_F1','Confusion_Matrix','Memory','Building_Time','Classification_Time'])
